...
! -> Capitalization of letters does matter
! -> Do not add more rows to keybinds (Max 5 per function)
! -> If you only want less keybinds, leave the others empty like this ""
*/
